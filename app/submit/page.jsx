  ...
  if (submitted) {
    return (
      (<div className="flex flex-col min-h-screen bg-red-50">
        ...
        <main
          className="flex-1 container mx-auto px-6 py-12 flex items-center justify-center">
          <div
            className="max-w-md w-full bg-white rounded-lg shadow-md p-8 border border-red-100 text-center">
            <CheckCircle2 className="mx-auto h-16 w-16 text-green-500 mb-4" />
            <h2 className="text-2xl font-bold text-red-600 mb-4">Thank You!</h2>
            <p className="text-red-800/80 mb-6">
              Your website suggestion has been submitted successfully. Our team will review it soon.
            </p>
    ...
    (<div className="flex flex-col min-h-screen bg-red-50">
      ...
      <main className="flex-1 container mx-auto px-6 py-12">
        <div
          ...
          <h2 className="text-2xl font-bold text-red-600 mb-6">Submit a Website</h2>
          <p className="text-red-800/80 mb-6">
            Know an interesting website that should be included in our collection? Submit it below and help others
            discover great content!
          </p>

          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-2">
              <label htmlFor="websiteName" className="text-sm font-medium text-red-800">
                Website Name
              </label>
              <Input
                id="websiteName"
            ...
            <div className="space-y-2">
              <label htmlFor="websiteUrl" className="text-sm font-medium text-red-800">
                Website URL
              </label>
              <Input
                id="websiteUrl"
            ...
            <div className="space-y-2">
              <label htmlFor="category" className="text-sm font-medium text-red-800">
                Category
              </label>
            ...
            <div className="space-y-2">
              <label htmlFor="description" className="text-sm font-medium text-red-800">
